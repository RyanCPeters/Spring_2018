...
public class ConsolColor {
    ...
    public static final String rd = "\u001B[5;31m";     // rd
    public static final String grn = "\u001B[32m";   // grn
    public static final String ylo = "\u001B[33m";  // ylo
    public static final String blu = "\u001B[34m";    // blu
    public static final String prpl = "\u001B[35m";  // prpl
    public static final String cyan = "\u001B[36m";    // cyan
    public static final String wht = "\u001B[37m";   // wht
