...
import jcdp.color.api.AbstractColoredPrinter;
import jcdp.color.api.Ansi.Attribute;
import jcdp.color.api.Ansi.BColor;
import jcdp.color.api.Ansi.FColor;
import jcdp.color.api.IColoredPrinter;
import jcdp.color.impl.UnixColoredPrinter;
import jcdp.color.impl.WindowsColoredPrinter;
...
public class ColoredPrinter implements IColoredPrinter
{
    ...
    public ColoredPrinter(Builder b) {
        if (System.getProperty("os.name").toLowerCase().startsWith("win"))
            setImpl(
              new WindowsColoredPrinter
                .Builder( b._level, b._timestampFlag)
                .withFormat( b._dateFormat )
                .attribute(b.get_attribute())
                .foreground(b._foregroundColor)
                .background(b._backgroundColor).build());
        else
    ...
    }// ends public static class Builder
